...
wd <- 'C:/Users/schav/OneDrive/03 Resources/Data/UN';
setwd(wd)
un <- read.csv("un-coincidence-2016.csv")
```
...
```{r next-steps, echo=FALSE, error=FALSE, message=FALSE, warning=FALSE, eval=TRUE}
# TODO: Combine data in single table
# TODO: Put in tidy data format
```
